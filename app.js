        ...
        */
        let produktKategorien = [
            ...
            },
            {
                name: "Abendessen",
                produkte: [
                    { id: 8, name: "Abendessen Normal", preis: 6.00, typ: "abendessen_normal" },
                    { id: 9, name: "Abendessen Vegetarisch", preis: 6.00, typ: "abendessen_vegetarisch" }
                ]
            },
        ...
        function tagesabschluss() {
           ...
           // Erstelle Backup-Objekt mit ALLEN Daten
            const backup = {
                ...
                version: "2.0",  // Versions-Info für spätere Kompatibilität
                benutzer: benutzer,
